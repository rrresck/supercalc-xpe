...
let subtractARes = document.getElementById("subtractA");
let subtractBRes = document.getElementById("subtractB");
...
function factorial (a, b) {
    if (a < 19) {
        let factorialAValue = i;

        for (var i = a; i > 1; i--) {
            factorialAValue *= i;
            return factorialAValue;
        }
...
const percentage = (a, b) => {
    percentageARes.innerHTML = ((a * 100)/b).toFixed(0) +'%';
    percentageBRes.innerHTML = ((b * 100)/a).toFixed(0) +'%';
}
